...
export const MichelinStars = React.memo(({
  ...
  return <div className="flex items-center gap-0">
      ...
      {displayStars > 0 && showLogo && <>
          ...
          <img src="/lovable-uploads/a19328d3-fb1d-41e4-b595-caaee16a8c16.png" alt="Michelin" className={`${size === 'sm' ? 'h-6' : size === 'md' ? 'h-8' : 'h-10'} object-cover ml-0.5`} style={{ clipPath: 'inset(20% 15% 20% 15%)' }} />
        </>}
