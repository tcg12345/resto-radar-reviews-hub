...
export function MobileRecommendationsMap({ userRatedRestaurants, onClose, onAddRestaurant }: MobileRecommendationsMapProps) {
  ...
  return (
    <div className="fixed inset-0 bg-background z-50 flex flex-col">
      ...
      {showBottomSheet && (
        <div 
          className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-2xl z-30 transition-all duration-300 ease-out"
          style={{ height: bottomSheetHeight }}
        >
          {/* Bottom Sheet Handle */}
          <div 
            className="flex justify-center py-3 cursor-pointer"
            onClick={toggleBottomSheetHeight}
          >
                ...
                <ScrollArea className="flex-1">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <Button
                        onClick={() => onAddRestaurant({ ...selectedRestaurant, userRating: 5 })}
                        variant="outline"
                        className="w-full"
                        size="sm"
                      >
                      ...
                      <div>
                        ...
                        <ScrollArea className="w-full whitespace-nowrap">
                          <div className="flex space-x-2 pb-2">
                            {selectedRestaurant.photos.slice(0, 5).map((photo, index) => (
                              <img
                                key={index}
                                src={photo}
