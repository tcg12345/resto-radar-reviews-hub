...
interface InlineRestaurantSearchProps {
  value?: RestaurantData | null;
...
export function InlineRestaurantSearch({ 
  value,
  onRestaurantSelect, 
  placeholder = "Search for a restaurant...",
  className,
  location
}: InlineRestaurantSearchProps) {
  ...
  const performSearch = async (query: string) => {
    ...
    try {
      ...
      const fullQuery = location ? `${query} ${location}` : `${query} restaurant`;
