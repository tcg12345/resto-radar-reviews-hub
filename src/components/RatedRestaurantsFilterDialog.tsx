...
export function RatedRestaurantsFilterDialog({
  ...
  return <>
      {/* Backdrop */}
      <div className="fixed inset-0 bg-black/60 z-modal-overlay" onClick={() => onOpenChange(false)} />
      
      {/* Bottom Sheet */}
      <div className="fixed bottom-0 left-0 right-0 bg-background border-t rounded-t-xl animate-in slide-in-from-bottom duration-300 h-[85vh] overflow-hidden z-modal" 
