-- Drop the specific function signatures
DROP FUNCTION IF EXISTS public.get_restaurant_community_stats(place_id_param text);
DROP FUNCTION IF EXISTS public.get_restaurant_community_stats(place_id_param text, requesting_user_id uuid);

-- Create the final working function for all restaurants
