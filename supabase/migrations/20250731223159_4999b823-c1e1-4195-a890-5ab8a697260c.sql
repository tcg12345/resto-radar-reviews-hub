-- Completely clean up all community functions
DROP FUNCTION IF EXISTS public.get_restaurant_community_stats CASCADE;
DROP FUNCTION IF EXISTS public.get_restaurant_reviews CASCADE;

-- Create the final, clean community stats function that works for all restaurants
...
-- Create the final, clean restaurant reviews function
