-- Fix type mismatch in get_friend_profile_with_pagination function
...
BEGIN
  ...
  WITH stats AS (
    SELECT 
      ...
      COALESCE(AVG(rating), 0)::numeric FILTER (WHERE is_wishlist = false AND rating IS NOT NULL) as avg_rating,
