...
CREATE INDEX IF NOT EXISTS idx_restaurants_user_id_created_at 
ON public.restaurants (user_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_restaurants_user_id_wishlist 
ON public.restaurants (user_id, is_wishlist);

CREATE INDEX IF NOT EXISTS idx_restaurants_user_id_rating 
