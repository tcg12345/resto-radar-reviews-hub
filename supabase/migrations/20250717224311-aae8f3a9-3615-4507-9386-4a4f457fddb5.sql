...
ALTER TABLE public.restaurants 
  ...
  ALTER COLUMN is_wishlist SET DEFAULT false;

-- Backfill existing rows (if any) with a system user ID or similar placeholder
-- This is needed temporarily to make the NOT NULL constraint work
